...
export interface ApiPersonaPersona extends Schema.CollectionType {
  ...
  attributes: {
    ci: Attribute.Text & Attribute.Unique;
    ...
    mayor_edad: Attribute.Boolean;
    estado_civil: Attribute.String;
    direccion: Attribute.String;
    telefono_fijo: Attribute.String;
    celular: Attribute.String;
    telefono_coorpo: Attribute.String;
    correo_electronico: Attribute.String;
    profesion: Attribute.String;
    libreta_militar: Attribute.String;
    nacionalidad: Attribute.String;
    lugar_nacimiento: Attribute.String;
    clase_de_documento: Attribute.String;
    fecha_ingreso: Attribute.Date;
    id_tipo_contrato: Attribute.Integer;
    baja: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
